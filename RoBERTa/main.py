...
def main(ids, masks, labels):
    ...
    train_dataloader = DataLoader(train_dataset, batch_size=8, shuffle=False, sampler=train_sampler, pin_memory=True)
    ...
    torch.save(params, "roberta.prm", pickle_protocol=4)



if __name__=="__main__":
    with open('/app/PoC/RoBERTa/input_label', 'rb') as f:
